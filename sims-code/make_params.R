...
# SBM0 with increasing mu, homogenous degrees
exper_name <- "SBM0_N=1000_B_20-100_Dhomo_increase_mu"
ps <- seq(0.05, 0.95, 0.05)
pname <- "mu"
nsims <- 3
extra_pars <- NULL
...
# SBM0 with increasing mu, homogenous degrees, worse community power law
exper_name <- "SBM0_N=1000_B_20-100_Dhomo_increase_mu_tau3"
ps <- seq(0.05, 0.95, 0.05)
pname <- "mu"
nsims <- 3
extra_pars <- NULL
...
# SBM0 with increasing mu, wide degree dist
exper_name <- "SBM0_N=1000_B_20-100_D_100-300_increase_mu_uniform"
ps <- seq(0.05, 0.95, 0.05)
pname <- "mu"
nsims <- 3
extra_pars <- NULL
make_code <- c("param_list <<- make_param_list(N = 1000, max_c = 100, min_c = 20, min_k = 100, max_k = 300, tau_2 = Inf, mu = ps[p])",
               "Gobj <<- DCSBM(param_list, type = 'slow', graph_tool = FALSE)",
               "Gp <<- Gobj$graph")
truth_code <- c("K <<- max(Gobj$membership)",
                "comms <<- lapply(1:K, function (i) which(Gobj$membership == i))")
...
# SBM0 with increasing mu, usual degree dist
exper_name <- "SBM0_N=1000_B_20-100_D_20-100_increase_mu_uniform"
ps <- seq(0.05, 0.95, 0.05)
pname <- "mu"
nsims <- 3
extra_pars <- NULL
make_code <- c("param_list <<- make_param_list(N = 1000, max_c = 100, min_c = 20, min_k = 20, max_k = 100, tau_2 = Inf, mu = ps[p])",
               "Gobj <<- DCSBM(param_list, type = 'slow', graph_tool = FALSE)",
               "Gp <<- Gobj$graph")
truth_code <- c("K <<- max(Gobj$membership)",
                "comms <<- lapply(1:K, function (i) which(Gobj$membership == i))")
...
# SBM0 with increasing mu, D = 100-200, uniform
exper_name <- "SBM0_N=1000_B_20-100_D_100-200_increase_mu_uniform"
ps <- seq(0.05, 0.95, 0.05)
pname <- "mu"
nsims <- 3
extra_pars <- NULL
make_code <- c("param_list <<- make_param_list(N = 1000, max_c = 100, min_c = 20, min_k = 100, max_k = 200, tau_2 = Inf, mu = ps[p])",
               "Gobj <<- DCSBM(param_list, type = 'slow', graph_tool = FALSE)",
               "Gp <<- Gobj$graph")
truth_code <- c("K <<- max(Gobj$membership)",
                "comms <<- lapply(1:K, function (i) which(Gobj$membership == i))")
...
# SBM0 with increasing mu, D = 100-200
exper_name <- "SBM0_N=1000_B_20-100_D_100-200_increase_mu"
ps <- seq(0.05, 0.95, 0.05)
pname <- "mu"
nsims <- 5
extra_pars <- NULL
make_code <- c("param_list <<- make_param_list(N = 1000, max_c = 100, min_c = 20, min_k = 100, max_k = 200, mu = ps[p])",
               "Gobj <<- DCSBM(param_list, type = 'slow', graph_tool = FALSE)",
               "Gp <<- Gobj$graph")
truth_code <- c("K <<- max(Gobj$membership)",
                "comms <<- lapply(1:K, function (i) which(Gobj$membership == i))")
